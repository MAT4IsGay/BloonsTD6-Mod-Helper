...
namespace BloonsTD6_Mod_Helper.Extensions
{
    public static class AddBehaviorToBloonModelBehaviorExt
    {
        ...
        {
            BehaviorUtils_Il2CppReferenceArray.RemoveBehavior<BloonBehaviorModel, T>(model.behaviors, behavior, out Il2CppReferenceArray<BloonBehaviorModel> moddedArray);
            model.behaviors = moddedArray;
        }
