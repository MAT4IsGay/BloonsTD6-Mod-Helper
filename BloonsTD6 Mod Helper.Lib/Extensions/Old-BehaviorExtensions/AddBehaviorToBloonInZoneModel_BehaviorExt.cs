...
namespace BloonsTD6_Mod_Helper.Extensions
{
    ...
    public static class AddBehaviorToBloonInZoneModel_BehaviorExt
    {
        public static bool HasBehavior<T>(this AddBehaviorToBloonInZoneModel model) where T : Model
        {
            return BehaviorUtils_Il2CppReferenceArray.HasBehavior<BloonBehaviorModel, T>(model.behaviors);
        }

        public static T GetBehavior<T>(this AddBehaviorToBloonInZoneModel model) where T : Model
        {
            return BehaviorUtils_Il2CppReferenceArray.GetBehavior<BloonBehaviorModel, T>(model.behaviors);
        }

        public static List<T> GetBehaviors<T>(this AddBehaviorToBloonInZoneModel model) where T : Model
        {
            return BehaviorUtils_Il2CppReferenceArray.GetBehaviors<BloonBehaviorModel, T>(model.behaviors)?.ToList();
        }

        public static void AddBehavior<T>(this AddBehaviorToBloonInZoneModel model, T behavior) where T : Model
        {
        ...
        public static void RemoveBehavior<T>(this AddBehaviorToBloonInZoneModel model) where T : Model
        {
        ...
        public static void RemoveBehavior<T>(this AddBehaviorToBloonInZoneModel model, T behavior) where T : Model
        {
        ...
        public static void RemoveBehaviors<T>(this AddBehaviorToBloonInZoneModel model) where T : Model
        {
